...
from self_attention_cv import TransformerEncoder, ViT, ResNet50ViT
import numpy as np
import argparse
import math
import argparse
...
parser.add_argument("-pre","--pre_trained",type = bool, default=False)
...
class Classifier(nn.Module):
    def __init__(self):
        ...
        self.out = nn.Linear(int(DIM * DIM * 0.75), 10)
...
def main():
    ...
    if pretrained == False:
        ...
        transformer = model.patch_embed
        transFn = 'pre_trans.pth'
        classFn = 'pre_trans.pth'
    # transformer.load_state_dict(torch.load(transFn))
