...
def main():
    ...
    dataloader = MiniImageNetDataLoader(shot_num=SAMPLE_NUM_PER_CLASS,\
        way_num=CLASS_NUM, episode_test_sample_num=BATCH_NUM_PER_CLASS)
    ...
    for episode in range(EPISODE):
        ...
        dataloader.get_batch(phase='train', idx=episode) #25*3*84*84
        print(samples.shape)
        exit()
